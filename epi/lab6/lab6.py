...
def graphs(): 
    ...
    for cplx in cplx_values:
        for mode in modes:
            ...
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий', 'очень высокий'], acap_result[0], label='ACAP')
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий', 'очень высокий'], aexp_result[0], label='AEXP')
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий', 'очень высокий'], pcap_result[0], label='PCAP')
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий'], lexp_result[0], label='LEXP')
            pyplot.ylabel("PM")
            pyplot.legend()

            pyplot.subplot(122)
            pyplot.title("Время Режим: " + mode + " ( CPLX=" + str(cplx) + ")")
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий', 'очень высокий'], acap_result[1], label='ACAP')
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий', 'очень высокий'], aexp_result[1], label='AEXP')
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий', 'очень высокий'], pcap_result[1], label='PCAP')
            pyplot.plot(['очень низкий', 'нихкий', 'номинальный', 'высокий'], lexp_result[1], label='LEXP')
            pyplot.ylabel("TM")
            pyplot.legend()
            pyplot.show()
